    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                .route("get_post_by_id", r -> r
                        ...
                        .and()
                        .method("GET")
                        .uri("http://posts-microservice:8080")
                )
                .route("get_posts", r -> r
                        .path("/api/v1/posts")
                        .and()
                ...
                .route("get_comment_by_id", r -> r
                        ...
                        .and()
                        .method("GET")
                        .uri("http://comments-microservice:8081")
                )
                ...
                .route("get_user_by_id", r -> r
                        ...
                        .and()
                        .method("GET")
                        .uri("http://users-microservice:8082")
                )
                .route("get_users", r -> r
                        .path("/api/v1/users")
                        .and()
                ...
                .route("get_topic_by_id", r -> r
                        ...
                        .and()
                        .method("GET")
                        .uri("http://topics-microservice:8084")
                )
                ...
                .route("query_users", r -> r.method("GET")
                        ...
                        .uri("http://query-microservice:8085")
                )
                ...
                .route("storage", r -> r
                        .path("/api/v1/storage/**")
                        .uri("http://storage-microservice:8088"))
                .build();
    }
}
